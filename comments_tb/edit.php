    ...
    <div class='container'>
      ...
      <div class='col-sm-10'>
        <div class='panel panel-info'>
          <div class='panel-heading'>Form Edit comments_tb </div>
          <div class='panel-body'>
            ...
            foreach($one as $data){?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="comment" name='comment' value="<?php echo $data['comment']; ?>">
                </div>
